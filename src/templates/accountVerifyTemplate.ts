...
export const accountVerifyTemplate = (data: TTemplateData) => /* html */ `
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>${data.companyName} - Verify Your Account</title>
  <style>
...
<body>
  <div class="email-container">
    ...
    <div class="header">
      ...
      <p>Secure your account in just one step</p>
    </div>
    ...
    <div class="content">
      ...
      <p class="paragraph">
        Welcome to <strong>${data.companyName}</strong>! To complete your registration and secure your account, 
    ...
    <div class="otp-section">
      ...
      <p class="expiry-text">
        This code expires in <span class="expiry-highlight">${data.expiryTime}</span>
      </p>
    </div>
    ...
    <div class="button-section">
      ...
      <p class="button-helper">Or copy and paste the code on the verification page</p>
    </div>
        ...
        <tr>
          ...
          <td style="vertical-align: top;">
            ...
            <p class="security-text">
              This code is confidential. We will never ask you to share it via phone, email, or any other means. 
    ...
    <div class="help-section">
      <p class="help-text">
        Having trouble verifying your account?<br>
    ...
    <div class="footer">
      ...
      <p class="footer-links">
        You're receiving this email because you signed up for ${data.companyName}.<br>
